    ...
    <div className='general-box-gestionusuarios'>
      ...
      <div className='div-box-header-text-gestionusuarios'>
        <div className='alinear-al-centro'>
          <h2><FontAwesomeIcon className='icon-title' icon={faUserGroup} />Gestión de Usuarios</h2>
        </div>
      ...
      <div className='box-formulario-gestionusuarios'>
        ...
        <form className='auth-form-gestionusuarios' onSubmit={handleCreateUser}>
          <div className='auth-form-gestionusuarios-area-rol'>
            <label className='rol-text' htmlFor="">Rol de Usuario:
              <div className="custom-select-container">
                ...
                >
                  <span>
                    {rol === '' ? 'Elige un rol...' :
                      rol === 'ALUMNO' ? 'Alumno' :
                        rol === 'PROFESOR' ? 'Profesor' : 'Administrador'}
                  </span>
                ...
                {isOpen && (
                  <div className="custom-select-dropdown">
                    <div className="custom-select-option" onClick={() => { setRol('ADMINISTRADOR'); setIsOpen(false); }}>
                      Administrador
                    </div>
                    <div className="custom-select-option" onClick={() => { setRol('PROFESOR'); setIsOpen(false); }}>
                      Profesor
                    </div>
                    <div className="custom-select-option" onClick={() => { setRol('ALUMNO'); setIsOpen(false); }}>
                      Alumno
                    </div>
                  </div>
                )}
          ...
          {/*Nombre completo*/}
          < div className='auth-form-gestionusuarios-area-form' >
